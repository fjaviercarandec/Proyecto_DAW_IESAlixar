...
public class PurchaseDetail implements Serializable{
	...
	@ManyToOne
	@JoinColumn(name = "id_purchase", nullable = false, foreignKey = @ForeignKey(name = "purchaseDetail_purchase"))
	private Purchase purchase;
	@ManyToOne
	@JoinColumn(name = "id_supplier", nullable = false, foreignKey = @ForeignKey(name = "purchaseDetail_supplier"))
	private Supplier supplier;
	@ManyToOne
	@JoinColumn(name = "id_product", nullable = false, foreignKey = @ForeignKey(name = "purchaseDetail_product"))
